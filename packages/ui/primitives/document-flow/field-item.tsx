    ...
    >
      ...
      {!disabled && selected && onRemove && (
        <button
          ...
          className="absolute -top-2.5 -right-2.5 z-[70] flex h-6 w-6 items-center justify-center rounded-full border-2 border-white bg-red-500 text-white shadow-md transition-colors hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400"
          onClick={(e) => {
            e.stopPropagation();
            onRemove();
          }}
