          ...
          <Dialog onOpenChange={() => setEnteredEmail('')}>
            ...
            <DialogContent>
              <DialogHeader className="space-y-4">
                ...
                <DialogDescription>
                  <Trans>
                    PSD Document Signing will delete <span className="font-semibold">all of your documents</span>, along
                    with all of your completed documents, signatures, and all other resources belonging to your Account.
                  </Trans>
                </DialogDescription>
              </DialogHeader>
