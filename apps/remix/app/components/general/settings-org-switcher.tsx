  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        ...
        {/*
          PSD401: "Create organisation" intentionally omitted — single-org district
          deployment has no use for creating additional organisations from a switcher
          (see org-menu-switcher.tsx and commit c6bb4a536).
        */}
      </PopoverContent>
    </Popover>
  );
