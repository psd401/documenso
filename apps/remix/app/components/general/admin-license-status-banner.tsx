...
// ABOUTME: PSD401 is self-hosted with no license key configured, so `license`
// is always null/NOT_FOUND here; the guard below already makes this a no-op
// (matches the fork's prior full-gutting intent without dropping the component).
