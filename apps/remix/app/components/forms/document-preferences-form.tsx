          ...
          <FormField
            ...
            render={({ field }) => (
              <InheritableField
                ...
                canInherit={canInherit}
                isInherited={field.value === null}
                label={<Trans>Restrict Document Sending</Trans>}
                testId="restrict-document-sending"
              >
                <Select
                  {...field}
                  value={field.value === null ? '-1' : field.value.toString()}
                ...
                <FormDescription>
                  <Trans>
                    When enabled, only team admins and managers can send documents for signing. Members can still create
