  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using PSD Document Signing to perform your electronic document signing. The purpose of this
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by PSD Document Signing, you affirm that you
            have read and understood this disclosure. You agree to all terms and conditions related to the use of
            electronic signatures and electronic transactions as outlined herein.
          </Trans>
        </p>
